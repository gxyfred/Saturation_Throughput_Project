...
NS_LOG_COMPONENT_DEFINE ("EE597_Project");
...
main(int argc, char *argv[])
{
  ...
  //Config::Set("/home/NS3/ns-3-allinone/ns-3.27/src/wifi/model/dca-txop.cc/CwMin", UintegerValue(cwmin));
  //Config::Set("/NodeList/0/DeviceList/0/Mac/DcaTxop/MinCw", UintegerValue(cwmin));
  //Config::Set("/NodeList/0/DeviceList/0/Mac/DcaTxop/MaxCw", UintegerValue(cwmax));
